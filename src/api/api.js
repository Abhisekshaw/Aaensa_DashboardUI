...
// ACCUWEATHER
export const WEATHER = (LocationKey) => weatherApi.get(`/currentconditions/v1/${LocationKey}?apikey=I2cIgi8ay0oM6H64voW7AHHjVw92UTtw&details=true`);

export const LOCATIONAPIKEY = (coordinate) => weatherApi.get(`/locations/v1/cities/geoposition/search?apikey=I2cIgi8ay0oM6H64voW7AHHjVw92UTtw&q=${coordinate.Lat},${coordinate.Long}`);